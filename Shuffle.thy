...
primrec Shuffle_single_list :: "('a\<times>'b) list \<Rightarrow>('a\<times>'b list) list \<Rightarrow>('a\<times>'b list) list"
  where "Shuffle_single_list [] list = list" |
        "Shuffle_single_list (x # xs) list = Shuffle_single_list xs (Shuffle_single_one x list)"

primrec Shuffle_single_llist :: "(('a\<times>'b) list) list \<Rightarrow>('a\<times>'b list) list \<Rightarrow>('a\<times>'b list) list"
...
lemma Shuffle_single_inputlistlist_lemma_right:"List.member (Shuffle_single_inputlistlist xss) (k,vs)
        \<Longrightarrow>List.member xss xs \<Longrightarrow>List.member xs (k,v) \<Longrightarrow>List.member vs v "
  apply (simp only: member_def)
  apply (induct xss)
...
lemma Shuffle_single_inputlistlist_lemma_left:"List.member (Shuffle_single_inputlistlist xss) (k,vs) 
        \<Longrightarrow> List.member vs v \<Longrightarrow> \<exists>xs. List.member xss xs \<and> List.member xs (k,v) "
  apply (simp only: member_def)
  apply (induct xss)
  apply (simp add:Shuffle_single_inputlistlist_def)+
...
theorem Shuffle_single_inputlistlist_theorem: "List.member (Shuffle_single_inputlistlist xss) (k,vs) \<Longrightarrow> 
...
lemma Shuffle_single_inputalist_lemma_right:" List.member (Shuffle_single_inputalist xs) (k,vs) 
        \<Longrightarrow> List.member xs (k,v) \<Longrightarrow> List.member vs v "
  apply (simp only: member_def)
  apply (induct xs)      
...
lemma Shuffle_single_inputalist_lemma_left:"List.member (Shuffle_single_inputalist xs) (k,vs) 
        \<Longrightarrow> List.member vs v \<Longrightarrow> List.member xs (k,v)"
  apply (simp only: member_def)
  apply (induct xs)      
  apply (simp add:Shuffle_single_inputalist_def)+
  apply (subgoal_tac "distinct (map fst [(fst a, [snd a])])")
...
theorem Shuffle_single_inputalist_theorem: "List.member (Shuffle_single_inputalist xs) (k,vs) \<Longrightarrow> 
        (List.member xs (k,v)) = (List.member vs v)"
  apply auto
...
primrec Shuffle_multi_emit :: "'a list \<Rightarrow> ('a\<times>'b) list \<Rightarrow> ('a\<times>'c) list \<Rightarrow>('a\<times>'b list\<times>'c list) list"
...
fun Shuffle_multi :: "('a\<times>'b) list \<Rightarrow> ('a\<times>'c) list \<Rightarrow>('a\<times>'b list\<times>'c list) list "
